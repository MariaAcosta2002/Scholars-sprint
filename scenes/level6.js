export class level6 extends Phaser.Scene{
    ...
    preload(){
        this.load.image('Juego', 'assets/img/Juego.jpg');
    ...
    create(){
        ...
        this.background = this.add.image(width / 2, height / 2, 'Juego').setOrigin(0.5);
        ...
        this.botonPauseResume = this.add.image(200, 40, 'btnPause').setInteractive();
